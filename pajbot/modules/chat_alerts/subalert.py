...
class SubAlertModule(BaseModule):
    ...
    SETTINGS = [
        ...
        ModuleSetting(
            ...
            type="text",
            required=True,
            placeholder="Sub hype! {username} just subscribed KomodoHype",
            default="Sub hype! {username} just subscribed KomodoHype",
        ...
        ModuleSetting(
            ...
            type="text",
            required=True,
            placeholder="Thank you for smashing that prime button! {username} KomodoHype",
            default="Thank you for smashing that prime button! {username} KomodoHype",
            constraints={"min_str_len": 10, "max_str_len": 400},
        ),
        ModuleSetting(
            key="new_gift_sub",
            ...
            type="text",
            required=True,
            placeholder="{gifted_by} gifted a fresh sub to {username}! KomodoHype",
            default="{gifted_by} gifted a fresh sub to {username}! KomodoHype",
            constraints={"min_str_len": 10, "max_str_len": 400},
        ),
        ModuleSetting(
            key="resub",
            ...
            type="text",
            required=True,
            placeholder="Resub hype! {username} just subscribed, {num_months} months in a row KomodoHype <3",
            default="Resub hype! {username} just subscribed, {num_months} months in a row KomodoHype <3",
            constraints={"min_str_len": 10, "max_str_len": 400},
        ),
        ModuleSetting(
            key="resub_prime",
        ...
        ModuleSetting(
            ...
            type="text",
            required=True,
            placeholder="{username} got gifted a resub by {gifted_by}, that's {num_months} months in a row KomodoHype",
            default="{username} got gifted a resub by {gifted_by}, that's {num_months} months in a row KomodoHype",
            constraints={"min_str_len": 10, "max_str_len": 400},
        ),
        ModuleSetting(
            ...
            type="text",
            required=True,
            placeholder="{num_months} in a row KomodoHype",
            default="{num_months} in a row KomodoHype",
            constraints={"min_str_len": 10, "max_str_len": 400},
        ),
        ModuleSetting(
            key="whisper_message",
